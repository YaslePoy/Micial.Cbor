...
namespace Micial.Cbor.Writer
{
    public partial class CborWriter
    {
        ...
        public void WriteEndMap()
        {
            ...
            {
                throw new InvalidOperationException(MSR.Cbor_Writer_MapIncompleteKeyValuePair);
            }
        ...
        private void WriteStartMapIndefiniteLength()
        {
            ...
            {
                throw new InvalidOperationException(MSR.Format(MSR.Cbor_ConformanceMode_IndefiniteLengthItemsNotSupported, ConformanceMode));
            }
