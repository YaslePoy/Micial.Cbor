...
namespace Micial.Cbor.Writer
{
    public partial class CborWriter
    {
        ...
        public void WriteTag(CborTag tag)
        {
            ...
            {
                throw new InvalidOperationException(MSR.Format(MSR.Cbor_ConformanceMode_TagsNotSupported, ConformanceMode));
            }
        ...
        public void WriteUnixTimeSeconds(double seconds)
        {
            ...
            {
                throw new ArgumentException(MSR.Cbor_Writer_ValueCannotBeInfiniteOrNaN, nameof(seconds));
            }
        ...
        internal static class DecimalHelpers
        {
            ...
            public static decimal Reconstruct(decimal mantissa, long exponent)
            {
                ...
                {
                    throw new OverflowException(MSR.Cbor_Writer_DecimalOverflow);
                }
                else if (exponent >= 0)
                {
