...
namespace System.Formats.Cbor
{
    ...
    public partial class CborReader
    {
        ...
        public CborReader(ReadOnlyMemory<byte> data, CborConformanceMode conformanceMode = CborConformanceMode.Strict, bool allowMultipleRootLevelValues = false)
        {
            ...
            if (allowMultipleRootLevelValues)
        ...
        private CborInitialByte PeekInitialByte()
        {
            ...
            {
                throw new InvalidOperationException(MSR.Cbor_Reader_NoMoreDataItemsToRead);
            }
            ...
            if (_offset == _data.Length)
            {
                ...
                throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_UnexpectedEndOfBuffer);
            }
            ...
            switch (_currentMajorType)
            {
                ...
                case CborMajorType.TextString:
                    ...
                    throw new CborContentException(MSR.Format(MSR.Cbor_Reader_InvalidCbor_IndefiniteLengthStringContainsInvalidDataItem, (int)nextByte.MajorType));
            }
        ...
        private CborInitialByte PeekInitialByte(CborMajorType expectedType)
        {
            ...
            {
                throw new InvalidOperationException(MSR.Format(MSR.Cbor_Reader_MajorTypeMismatch, (int)result.MajorType));
            }
        ...
        private void ValidateNextByteIsBreakByte()
        {
            ...
            {
                throw new InvalidOperationException(MSR.Cbor_NotAtEndOfIndefiniteLengthDataItem);
            }
        }
        ...
        private void PopDataItem(CborMajorType expectedType)
        {
            ...
            {
                throw new InvalidOperationException(MSR.Format(MSR.Cbor_PopMajorTypeMismatch, (int)_currentMajorType.Value));
            }

            if (_definiteLength - _itemsRead > 0)
            {
                throw new InvalidOperationException(MSR.Cbor_NotAtEndOfDefiniteLengthDataItem);
            }

            if (_isTagContext)
            {
                throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_TagNotFollowedByValue);
            }
