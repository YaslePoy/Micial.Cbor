    ...
    public partial class CborReader
    {
        ...
        private ulong PeekUnsignedInteger(out int bytesRead)
        {
            ...
            switch (header.MajorType)
            {
                ...
                default:
                    throw new InvalidOperationException(MSR.Format(MSR.Cbor_Reader_MajorTypeMismatch, (int)header.MajorType));
            }
        }
        ...
        private ulong DecodeUnsignedInteger(CborInitialByte header, ReadOnlySpan<byte> data, out int bytesRead)
        {
            ...
            switch (header.AdditionalInfo)
            {
                ...
                default:
                    throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_InvalidIntegerEncoding);
            }
            ...
            void ValidateIsNonStandardIntegerRepresentationSupported()
            {
                ...
                {
                    throw new CborContentException(MSR.Format(MSR.Cbor_ConformanceMode_NonCanonicalIntegerRepresentation, ConformanceMode));
                }
            }
        }
    }
