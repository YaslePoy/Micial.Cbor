                ...
                if (_definiteLength is null)
                {
                    switch (_currentMajorType)
                    {
                        case null:
                            ...
                            Debug.Assert(AllowMultipleRootLevelValues);
                            throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_UnexpectedBreakByte);
            ...
            if (_definiteLength is null && _currentMajorType != null)
            {
                ...
                switch (_currentMajorType.Value)
                {
                    ...
                    case CborMajorType.TextString:
                        ...
                        {
                            throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_IndefiniteLengthStringContainsInvalidDataItem);
                        }
