    ...
    public partial class CborReader
    {
            ...
            try
            {
                ...
                switch (PeekState())
                {
                    ...
                    case CborReaderState.StartIndefiniteLengthTextString:
                        break;
                    default:
                        throw new CborContentException(MSR.Cbor_Reader_InvalidDateTimeEncoding);
                }
            ...
            try
            {
                ...
                switch (PeekState())
                {
                    ...
                    case CborReaderState.DoublePrecisionFloat:
                        ...
                        {
                            throw new CborContentException(MSR.Cbor_Reader_InvalidUnixTimeEncoding);
                        }
        ...
        public BigInteger ReadBigInteger()
        {
            ...
            try
            {
                bool isNegative = ReadTag() switch
                {
                    ...
                    _ => throw new InvalidOperationException(MSR.Cbor_Reader_InvalidBigNumEncoding),
                };
                ...
                switch (PeekState())
                {
                    ...
                    case CborReaderState.StartIndefiniteLengthByteString:
                        break;
                    default:
                        throw new CborContentException(MSR.Cbor_Reader_InvalidBigNumEncoding);
                }
        ...
        public decimal ReadDecimal()
        {
            ...
            try
            {
                ...
                {
                    throw new CborContentException(MSR.Cbor_Reader_InvalidDecimalEncoding);
                }
        ...
        private void ReadExpectedTag(CborTag expectedTag)
        {
            ...
            if (expectedTag != tag)
            {
                throw new InvalidOperationException(MSR.Cbor_Reader_TagMismatch);
            }
        ...
        private CborTag PeekTagCore(out int bytesRead)
        {
            ...
            {
                throw new CborContentException(MSR.Format(MSR.Cbor_ConformanceMode_TagsNotSupported, ConformanceMode));
            }
