    ...
    public partial class CborReader
    {
        ...
        public byte[] ReadByteString()
        {
            ...
            if (header.AdditionalInfo == CborAdditionalInfo.IndefiniteLength)
            {
                ...
                {
                    throw new CborContentException(MSR.Format(MSR.Cbor_ConformanceMode_IndefiniteLengthItemsNotSupported, ConformanceMode));
                }
        ...
        public void ReadStartIndefiniteLengthByteString()
        {
            ...
            if (header.AdditionalInfo != CborAdditionalInfo.IndefiniteLength)
            {
                throw new InvalidOperationException(MSR.Cbor_Reader_NotIndefiniteLengthString);
            }
        ...
        public string ReadTextString()
        {
            ...
            {
                throw new CborContentException(MSR.Cbor_Reader_InvalidCbor_InvalidUtf8StringEncoding, e);
            }
