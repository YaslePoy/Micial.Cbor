    ...
    public partial class CborReader
    {
        ...
        public float ReadSingle()
        {
            ...
            switch (header.AdditionalInfo)
            {
                ...
                case CborAdditionalInfo.Additional64BitData:
                    throw new InvalidOperationException(MSR.Cbor_Reader_ReadingAsLowerPrecision);

                default:
                    throw new InvalidOperationException(MSR.Cbor_Reader_NotAFloatEncoding);
        ...
        public bool ReadBoolean()
        {
            ...
            bool result = header.AdditionalInfo switch
            {
                ...
                _ => throw new InvalidOperationException(MSR.Cbor_Reader_NotABooleanEncoding),
            };
        ...
        public void ReadNull()
        {
            ...
            switch (header.AdditionalInfo)
            {
                case (CborAdditionalInfo)CborSimpleValue.Null:
                    ...
                    return;
                default:
                    throw new InvalidOperationException(MSR.Cbor_Reader_NotANullEncoding);
            }
        }
        ...
        public CborSimpleValue ReadSimpleValue()
        {
            ...
            switch (header.AdditionalInfo)
            {
                ...
                case CborAdditionalInfo.Additional8BitData:
                    ...
                    {
                        throw new CborContentException(MSR.Format(MSR.Cbor_ConformanceMode_InvalidSimpleValueEncoding, ConformanceMode));
                    }
                ...
                default:
                    throw new InvalidOperationException(MSR.Cbor_Reader_NotASimpleValueEncoding);
            }
        }
    }
}
